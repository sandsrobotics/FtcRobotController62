...
@I2cDeviceType
@DeviceProperties(name = "DFR Range Sensor", description = "DFR Range Sensor", xmlTag = "DFRURM09RangeV2", compatibleControlSystems = ControlSystem.REV_HUB, builtIn = true)
public class DFR304Range extends I2cDeviceSynchDeviceWithParameters<I2cDeviceSynch, DFR304Range.Parameters> {
    ...
    // CFG_INDEX
    // Bit7(control bit in ranging mode) 0: passive measurement, send ranging
    //////////////////////////////////////////////////////////////////////////////////////////////// command
    //////////////////////////////////////////////////////////////////////////////////////////////// once,
    // the module ranges the distance once and store the measured value into the
    //////////////////////////////////////////////////////////////////////////////////////////////// distance
    //////////////////////////////////////////////////////////////////////////////////////////////// register.
    // 1: automatic measurement mode, the module keeps ranging distance and updating
    //////////////////////////////////////////////////////////////////////////////////////////////// the
    //////////////////////////////////////////////////////////////////////////////////////////////// distance
    //////////////////////////////////////////////////////////////////////////////////////////////// register
    //////////////////////////////////////////////////////////////////////////////////////////////// all
    ...
    public enum Register {
        FIRST(0x00), PID_INDEX(0x01), VERSION_INDEX(0x02), DIST_H_INDEX(0x03), DIST_L_INDEX(0x04), TEMP_H_INDEX(0x05),
        TEMP_L_INDEX(0x06), CFG_INDEX(0x07), CMD_INDEX(0x08), LAST(CMD_INDEX.bVal);
    ...
    public enum MaxRange {
        CM150(0x00), CM300(0x10), CM500(0x20);
    ...
    public DFR304Range(I2cDeviceSynch deviceClient) {
        ...
        // Sensor starts off disengaged so we can change things like I2C address. Need
        // to engage
        this.deviceClient.engage();
    }

    protected void setOptimalReadWindow() {
        // Sensor registers are read repeatedly and stored in a register. This method
        // specifies the
        // registers and repeat read mode
        I2cDeviceSynch.ReadWindow readWindow = new I2cDeviceSynch.ReadWindow(Register.FIRST.bVal,
                Register.LAST.bVal - Register.FIRST.bVal + 1, I2cDeviceSynch.ReadMode.REPEAT);
